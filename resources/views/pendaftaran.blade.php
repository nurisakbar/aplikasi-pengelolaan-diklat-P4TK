...
<html lang="en">
	...
	<body id="kt_body" class="bg-body">
		...
		<div class="d-flex flex-column flex-root">
			...
			<div class="d-flex flex-column flex-column-fluid bgi-position-y-bottom position-x-center bgi-no-repeat bgi-size-contain bgi-attachment-fixed" style="background-image: url(/metronic8/demo11/assets/media/illustrations/sketchy-1/14.png">
				<!--begin::Content-->
					...
					<div class="w-lg-600px bg-body rounded shadow-sm p-10 p-lg-15 mx-auto">
						...
						<form class="form w-100" novalidate="novalidate" id="kt_sign_up_form">
							...
							<div class="mb-10 text-center">
								...
								<a href="/metronic8/demo11/../demo11/authentication/layouts/basic/sign-in.html" class="link-primary fw-bolder">Login Disini</a></div>
								<!--end::Link-->
							</div>
							<!--end::Heading-->
							<!--begin::Action-->
							<button type="button" class="btn btn-light-primary fw-bolder w-100 mb-10">
							<img alt="Logo" src="{{asset('assets/media/svg/brand-logos/google-icon.svg')}}" class="h-20px me-3" />Daftar Dengan Google</button>
							<!--end::Action-->
							<!--begin::Separator-->
							...
							<div class="text-center">
								<button type="button" id="kt_sign_up_submit" class="btn btn-lg btn-danger">
									Daftar Sekarang
								</button>
