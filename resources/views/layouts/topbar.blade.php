                ...
                <div class="menu-item px-3">
                    <div class="menu-content d-flex align-items-center px-3">
                        ...
                        <div class="symbol symbol-50px me-5">
                            @if(Auth::guard('gtk')->user()!=null)
                                @if(Auth::guard('gtk')->user()->photo!==null)
                                    <img alt="Logo" src="{{ Auth::guard('gtk')->user()->photo}}">
                                @elseif(session('avatar')!=null)
                                    <img alt="Logo" src="{{ session('avatar') }}">
                                @else
                                    <img alt="Logo" src="{{ asset('assets/media/avatars/150-8.jpg') }}">
                                @endif
                            @else
                                <img alt="Logo" src="{{ asset('assets/media/avatars/150-8.jpg') }}">
                            @endif
                        ...
                        <div class="d-flex flex-column">
                            ...
                            if(Auth::guard('gtk')->user()!=null)
                            {
                                $name = Auth::guard('gtk')->user()->nama_lengkap;
                                $sub = Auth::guard('gtk')->user()->nomor_ukg;
                            }else{
                                $name = Auth::user()->name;
                                $sub = "administrator";
                            }
                            ...
                            <a href="#" class="fw-bold text-muted text-hover-primary fs-7">{{ $sub }}</a>
                        </div>
                        <!--end::Username-->
                    </div>
                </div>
