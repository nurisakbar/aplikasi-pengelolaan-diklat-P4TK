            ...
            @if (Auth::check())
                ...
                <div data-kt-menu-trigger="click" data-kt-menu-placement="bottom-start"
                    ...
                    <div
                        ...
                        <div class="menu-item">
                            <a class="menu-link py-3" href="{{ url('provinsi') }}">
                                <span class="menu-icon">
                                    <!--begin::Svg Icon | path: icons/duotune/general/gen009.svg-->
                                    <span class="svg-icon svg-icon-2">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                        ...
                        <div class="menu-item">
                            <a class="menu-link py-3" href="{{ url('regency') }}">
                                <span class="menu-icon">
                                    <!--begin::Svg Icon | path: icons/duotune/general/gen009.svg-->
                                    <span class="svg-icon svg-icon-2">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                ...
                                <span class="menu-title">Data Kabupaten</span>
                            </a>
                        </div>
                        <div class="menu-item">
                            <a class="menu-link py-3" href="{{ url('district') }}">
                                <span class="menu-icon">
                                    <!--begin::Svg Icon | path: icons/duotune/general/gen009.svg-->
                                    <span class="svg-icon svg-icon-2">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
